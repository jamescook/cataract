...
// NewRule struct field indices (id, selector, declarations, specificity)
#define NEW_RULE_ID 0
#define NEW_RULE_SELECTOR 1
#define NEW_RULE_DECLARATIONS 2
#define NEW_RULE_SPECIFICITY 3
