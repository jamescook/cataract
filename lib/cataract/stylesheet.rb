  ...
  class Stylesheet
    ...
    def to_s(media: :all)
      ...
      if which_media_array.include?(:all)
        Cataract._stylesheet_to_s(@rules, media_index, @charset, @_has_nesting || false, @_selector_lists, @media_queries, @_media_query_lists)
      else
        ...
        Cataract._stylesheet_to_s(filtered_rules, filtered_media_index, @charset, @_has_nesting || false, @_selector_lists, @media_queries, @_media_query_lists)
      end
    end
    alias to_css to_s
    ...
    def to_formatted_s(media: :all)
      ...
      # If :all is present, return everything (no filtering)
      if which_media_array.include?(:all)
        Cataract._stylesheet_to_formatted_s(@rules, media_index, @charset, @_has_nesting || false, @_selector_lists, @media_queries, @_media_query_lists)
      else
        # Collect all rule IDs that match the requested media types
        matching_rule_ids = []
        mi = media_index # Build media_index if needed
        ...
        # Serialize with filtered data
        Cataract._stylesheet_to_formatted_s(filtered_rules, filtered_media_index, @charset, @_has_nesting || false, @_selector_lists, @media_queries, @_media_query_lists)
      end
    end
