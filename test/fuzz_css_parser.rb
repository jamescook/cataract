...
ITERATIONS.times do |i|
  ...
  result, error, crashed_input, stderr_output, merge_tested, to_s_tested = parse_in_worker(stdin, stdout, stderr,
  ...
  when :crash
    ...
    warn "Reproduce with: ruby -Ilib test/fuzz_css_parser.rb #{ITERATIONS} #{RNG_SEED}"
