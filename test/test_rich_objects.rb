...
class TestRichObjects < Minitest::Test
  ...
  def test_declarations_merge_with_hash
  ...
  def test_declarations_merge_bang
    decl = Cataract::Declarations.new({"color" => "red"})

    decl.merge!({"background" => "blue"})
  ...
  def test_declarations_equality
